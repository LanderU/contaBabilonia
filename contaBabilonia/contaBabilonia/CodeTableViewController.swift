...
//  contaBabilonia
//
//  Created by Lander on 14/1/16.
//  Copyright © 2016 Lander. All rights reserved.
//
...
class CodeTableViewController: UITableViewController {
    ...
    var campoTotal = String(PFUser.currentUser()!["total"])
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Cargamos el nombre en el textLabel y el total
        nombre.text! = "\(usuarioActivo.username!): \(campoTotal)"
